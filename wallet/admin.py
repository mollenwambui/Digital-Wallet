...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ("first_name","last_name","adress","email","phone_number","age","pin","gender","id_number","nationality","occupation","signature",)
...
class CardAdmin(admin.ModelAdmin):
    list_display = ("date_issued","card_name","card_number","card_type","expiry_date","card_status","security_code","signature","wallet","account","issuer",)
